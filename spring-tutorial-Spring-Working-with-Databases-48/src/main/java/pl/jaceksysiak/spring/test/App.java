...
public class App {
	...
	public static void main(String[] args) {
		...
		bchcr_offers.add(new Offer("alex1", "dd1@wp.pl", "alex1alex1alex1alex1alex1alex1"));
		bchcr_offers.add(new Offer("alex2", "dd2@wp.pl", "alex2alex2alex2alex2alex2alex2"));
		bchcr_offers.add(new Offer("alex3", "dd3@wp.pl", "alex3alex3alex3alex3alex3alex3alex3"));
		bchcr_offers.add(new Offer("alex4", "dd4@wp.pl", "alex4alex4alex4alex4alex4alex4alex4alex4alex4"));
